	...
	struct Line_style
		  {
				...
				Line_style (Line_style_type lst, int ww) : s(lst),
														   w(ww)
				  { }
		...
		Shape
		  {
				...
				Rectangle (Point xy, int ww, int hh) : w {ww},
													   h {hh}
				  {
					if (h <= 0 || w <= 0)
				...
				Rectangle (Point x, Point y) : w {y.x - x.x},
											   h {y.y - x.y}
				  {
					if (h <= 0 || w <= 0)
