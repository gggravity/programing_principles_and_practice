...
function(get_hash_for_ref ref out_var err_var)
    execute_process(
            COMMAND "C:/msys64/usr/bin/git.exe" rev-parse "${ref}^0"
...
execute_process(
        COMMAND "C:/msys64/usr/bin/git.exe" show-ref "v3.0.0-preview3"
        WORKING_DIRECTORY "C:/Users/martin.LAPLAND/CLionProjects/programing-principles-and-practice/c14/e8/build/_deps/catch2-src"
...
if (fetch_required)
    ...
    execute_process(
            COMMAND "C:/msys64/usr/bin/git.exe" fetch --tags --force "origin"
            WORKING_DIRECTORY "C:/Users/martin.LAPLAND/CLionProjects/programing-principles-and-practice/c14/e8/build/_deps/catch2-src"
...
if (git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
    ...
    execute_process(
            COMMAND "C:/msys64/usr/bin/git.exe" symbolic-ref -q HEAD
            WORKING_DIRECTORY "C:/Users/martin.LAPLAND/CLionProjects/programing-principles-and-practice/c14/e8/build/_deps/catch2-src"
    ...
    if (current_branch STREQUAL "")
        ...
        execute_process(
                COMMAND "C:/msys64/usr/bin/git.exe" for-each-ref "--format='%(upstream:short)'" "${current_branch}"
                WORKING_DIRECTORY "C:/Users/martin.LAPLAND/CLionProjects/programing-principles-and-practice/c14/e8/build/_deps/catch2-src"
...
if (need_stash)
    execute_process(
            COMMAND "C:/msys64/usr/bin/git.exe" stash save --quiet;--include-untracked
            WORKING_DIRECTORY "C:/Users/martin.LAPLAND/CLionProjects/programing-principles-and-practice/c14/e8/build/_deps/catch2-src"
            COMMAND_ERROR_IS_FATAL ANY
    )
endif ()
...
if (git_update_strategy STREQUAL "CHECKOUT")
    execute_process(
            COMMAND "C:/msys64/usr/bin/git.exe" checkout "${checkout_name}"
            WORKING_DIRECTORY "C:/Users/martin.LAPLAND/CLionProjects/programing-principles-and-practice/c14/e8/build/_deps/catch2-src"
            COMMAND_ERROR_IS_FATAL ANY
    )
else ()
    execute_process(
            COMMAND "C:/msys64/usr/bin/git.exe" rebase "${checkout_name}"
            WORKING_DIRECTORY "C:/Users/martin.LAPLAND/CLionProjects/programing-principles-and-practice/c14/e8/build/_deps/catch2-src"
            RESULT_VARIABLE error_code
    ...
    if (error_code)
        ...
        if (NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
            ...
            message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/martin.LAPLAND/CLionProjects/programing-principles-and-practice/c14/e8/build/_deps/catch2-src'."
        ...
        execute_process(
                COMMAND "C:/msys64/usr/bin/git.exe" tag -a
...
if (need_stash)
    ...
    if (error_code)
        ...
        if (error_code)
            ...
            message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/martin.LAPLAND/CLionProjects/programing-principles-and-practice/c14/e8/build/_deps/catch2-src'."
                    "\nYou will have to resolve the conflicts manually")
        endif ()
    endif ()
endif ()
